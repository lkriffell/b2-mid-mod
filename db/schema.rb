...
ActiveRecord::Schema.define(version: 2020_09_21_153609) do
  ...
  create_table "airline_flights", force: :cascade do |t|
    t.bigint "airline_id"
    t.bigint "flight_id"
    t.index ["airline_id"], name: "index_airline_flights_on_airline_id"
    t.index ["flight_id"], name: "index_airline_flights_on_flight_id"
  end
  ...
  add_foreign_key "airline_flights", "flights"
